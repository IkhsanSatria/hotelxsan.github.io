            ...
            <div class="card card-primary">
              ...
              <form action="simpan_edit.php" method ="post" autocomplete="off" enctype="multipart/form-data">
                <?php
                  ...
                  include "../koneksi.php";
                  $id_kamar = $_GET['id'];
                  $query = mysqli_query($koneksi, "SELECT * FROM kamar where 
                    id_kamar = $id_kamar");
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <div class="custom-file">
                      <img src="../img/<?php echo $data["gambar_kamar"]; ?>"
                      width = 100 title="<?php echo $data['gambar_kamar']; ?>">
                      </div>
                    </div>
                  </div>
                </div>
...
<script src="../dashboard1/plugins/bs-custom-file-input/bs-custom-file-input.min.js"></script>
<!-- AdminLTE App -->
